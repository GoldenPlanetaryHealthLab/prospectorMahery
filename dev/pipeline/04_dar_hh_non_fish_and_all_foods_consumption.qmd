---
subtitle: "DARWIN Household Total 1-week Non-Fish Consumption"
filters:
  - sorting-hat
  - ripper
extensions:
  ...
  ripper:
    ...
    output-name: "test-pipeline_node-4"
    script-links-position: "none"
format: gfm
---

In this step, we'll obtain total household 1-week consumption of non-fish foods for DARWIN.
Total non-fish consumption is calculated using only the weekly recall. 
