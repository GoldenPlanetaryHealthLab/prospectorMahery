...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Prospector for MAHERY Project Data",
    Description = "Dataset prospector to generate the MAHERY data set related to the project \"Cohort Profile: The Madagascar Health and Environmental Research (MAHERY) study in north-eastern Madagascar\".",
    `Authors@R` = c(
      person(given=c("Tinashe", "Michael"), family = "Tapera", email = "ttapera@hsph.harvard.edu", role = c("aut", "cre"), comment = c(ORCID = "0000-0001-9080-5010")),
      person(given=c("Christopher"), family = "Golden", email = "golden@hsph.harvard.edu", role = c("cph"), comment = c(ORCID = "0000-0002-2258-7493")),
      person(given=c("Stephanie"), family = "Wu", email = "swu@g.harvard.edu", role = c("aut", "ctb", "dtc"), comment = c(ORCID = "0000-0002-2258-7493"))
    )
  ),
  overwrite = TRUE
)
...
# Code of Conduct
usethis::use_code_of_conduct("tinashemtapera@gmail.com")
# NEWS
usethis::use_news_md()
```
