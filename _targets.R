...
list(
  ...
  tar_target(script_r_load_data_r, "R/load_data.R", format = "file"),
  tar_target(
    output_r_load_data_r,
    {
      script_r_load_data_r
      ...
      callr::r(
        ...
        args = list(script_path = "R/load_data.R")
      )
      character(0)
    },
    format = "file"
  ),
  tar_target(script_r_pipeline_r, "R/Pipeline.R", format = "file"),
  tar_target(
    output_r_pipeline_r,
    {
      script_r_pipeline_r
      callr::r(
        ...
        args = list(script_path = "R/Pipeline.R")
      )
      character(0)
    },
    format = "file"
